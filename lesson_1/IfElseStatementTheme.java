public class IfElseStatementTheme {
    ...
    public static void main(String[] args) {
        ...
        double height = 1.9;
        String string = "Иван";
        char firstLetterOfName = string.charAt(0);
        if(age > 20) {
        ...
        double deposit = 300000; // депозит
        double interestRate = 0; // процентная ставка
        double interest = 0; // процент
        double totalAmount = 0; // итоговая сумма
        if (deposit < 100000) {
            interestRate = 0.05;
